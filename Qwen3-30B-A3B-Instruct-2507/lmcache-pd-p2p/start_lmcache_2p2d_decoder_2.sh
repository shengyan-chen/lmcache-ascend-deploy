...
export LMCACHE_CONFIG_FILE="$SCRIPT_DIR/lmcache-2p2d-tp2-decoder-2.yaml"
...
LOG_DIR="${LOG_ROOT:-/mnt/sdb/csy/p2p/logs-lmcache-pd-p2p-test/2p2d/lmcache/decoder-node2}"
mkdir -p "$LOG_DIR"
