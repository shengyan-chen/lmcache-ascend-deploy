...
export LMCACHE_CONFIG_FILE="$SCRIPT_DIR/lmcache-2p2d-tp2-prefiller-1.yaml"
...
LOG_DIR="${LOG_ROOT:-/mnt/sdb/csy/p2p/logs-lmcache-pd-p2p-test/2p2d/lmcache/prefiller-node1}"
mkdir -p "$LOG_DIR"
