...
MOONCAKE_SCRIPT_ROOT="$SCRIPT_DIR"
LOG_ROOT="/mnt/sdb/csy/p2p/logs-pd-kv/minimax27/base-mooncake"
...
export MOONCAKE_CONFIG_PATH="${MOONCAKE_SCRIPT_ROOT}/mooncake.json"
export ASCEND_BUFFER_POOL=4:8
timestamp=$(date "+%Y%m%d%H%M%S")

export ASCEND_RT_VISIBLE_DEVICES=0,1,2,3,4,5,6,7

mkdir -p "${LOG_ROOT}/prefiller-node2"
...
vllm serve /workspace/models/MiniMax-M2.7-w8a8-QuaRot \
  ...
  > "${LOG_ROOT}/prefiller-node2/mooncake_${timestamp}.log" 2>&1 &
