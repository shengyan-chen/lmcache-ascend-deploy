...
export LMCACHE_CONFIG_FILE="${LMCACHE_SCRIPT_ROOT}/lmcache-pd-p2p-minimax27-decoder-2.yaml"
...
vllm serve /workspace/models/MiniMax-M2.7-w8a8-QuaRot \
  ...
  > "${LOG_ROOT}/decoder-node2/lmcache_${timestamp}.log" 2>&1 &
